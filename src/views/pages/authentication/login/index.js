...
const useStyles = makeStyles((theme) => ({
  root: {
    backgroundColor: theme.palette.primary.hubBackground,
    height: "100%",
    minHeight: "100vh",
    width: "100%",
  },
...
const Login = () => {
  ...
  const items = [
    {
      title: "Finrocks Hub",
      description: "A powerful tool to find the best tech talent in the world!",
    },
    {
        ...
        <Grid item md={5} sx={{ alignSelf: "stretch" }}>
          <Box
            ...
            sx={{
              ...
              margin: "0 0 0 auto",
              background:
                "url(https://finrocks.com/images/common/video-preview.jpg)",
              backgroundPosition: "center",
